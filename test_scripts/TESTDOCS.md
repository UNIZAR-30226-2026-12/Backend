...
* **Bloque 3: Abandono definitivo por timeout:** Comprueba la lógica de finalización por desconexión. Valida la activación del temporizador de 30 segundos, la victoria por incomparecencia y la correcta limpieza de la `RAM` (prevención de `Memory Leaks` de timers y salas zombis).
